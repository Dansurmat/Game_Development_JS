...
export class StandingLeft extends State { //STATE ONE
    constructor(player){
        super('STANDING LEFT');
        this.player = player;
    }
...
export class StandingRight extends State { //STATE TWO
    constructor(player){
...
export class SittingLeft extends State { // STATE THREE
    constructor(player){
        super('SITTING   LEFT');
        this.player = player;
    }
...
export class SittingRight extends State { // STATE FOUR
    constructor(player){
        super('SITTING RIGHT');
        this.player = player;
    }
...
export class RunningLeft extends State { // STATE FIVE
    constructor(player){
        super('RUNNING LEFT');
        this.player = player;
    }
...
export class RunningRight extends State { // STATE SIX
    constructor(player){
        super('RUNNING RIGHT');
        this.player = player;
    }
...
export class JumpingLeft extends State { // STATE SEVEN
    constructor(player){
        super('JUMPING LEFT');
        this.player = player;
    }
...
export class JumpingRight extends State { // STATE EIGHT
    constructor(player){
        super('JUMPING RIGHT');
        this.player = player;
    }
...
export class FallingLeft extends State { // STATE NINE
    constructor(player){
        super('FALLING LEFT');
        this.player = player;
    }
...
export class FallingRight extends State { // STATE TEN
    constructor(player){
        super('FALLING RIGHT');
        this.player = player;
